...
//							case FourWheel_Car: Set_Pwm(MOTOR_A.Motor_Pwm, -MOTOR_B.Motor_Pwm,  -MOTOR_C.Motor_Pwm, MOTOR_D.Motor_Pwm); break; //FourWheel car           //四驱车 
//							case Tank_Car:      Set_Pwm(MOTOR_A.Motor_Pwm,  MOTOR_B.Motor_Pwm,   MOTOR_C.Motor_Pwm, MOTOR_D.Motor_Pwm); break; //Tank Car                //履带车
//					 }
...
//	PWMA2=16799,PWMA1=16799-motor_a;
					 M5=0;   
			 M6=1;	 
             TIM_SetCompare1(TIM5,motor_a);    //左后轮
...
//	PWMB2=16799,PWMB1=16799-motor_b;
			 M1=0;   
			 M2=1;	 
			 TIM_SetCompare2(TIM5,motor_b);    //左前轮
...
//		PWMC2=16799,PWMC1=16799-motor_c;
			  M3=0;
			 M4=1;
             TIM_SetCompare3(TIM5,motor_c);   //右前轮
...
//		PWMD2=16799,PWMD1=16799-motor_d;
			 ...
			 TIM_SetCompare4(TIM5,motor_d);   //右后轮	
...
//	Velocity1=Position_PID1(Position1,servo1);//舵机PID控制
//	Velocity2=Position_PID2(Position2,servo2);//舵机PID控制
//	Velocity3=Position_PID3(Position3,servo3);//舵机PID控制
//	Velocity4=Position_PID4(Position4,servo4);//舵机PID控制
//	Velocity5=Position_PID5(Position5,servo5);//舵机PID控制
//	Velocity6=Position_PID6(Position6,servo6);//舵机PID控制
...
//		if(RC_Velocity<0)   RC_Velocity=0;
    ...
    //单位转换，mm/s -> m/s	
		...
		Move_Z=Move_Z;
				...
				if(PS2_LX<100 && PS2_RX>200)  Move_X=0,Move_Y=0,Move_Z=0;  //进入和退出舵机微调模式时,防止小车乱走
