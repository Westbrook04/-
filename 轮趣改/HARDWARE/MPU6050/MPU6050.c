...
extern int code_number1;
extern int code_number2;
extern int code_number3;
extern int code_number4;
extern int code_number5;
extern int code_number6;
extern u8 b[8];
extern u8 cc[11];
//uint16_t distance=0;
...
//    return b;
//}
void startTimeTask(void *pvParameters) {
    // 调用 start_Time() 初始化定时器
//    start_Time();
...
//        printf("Time: %f ms\n", time);
//        
//        vTaskDelay(pdMS_TO_TICKS(100));  // 延迟任务执行
//    }
}
...
//		printf("code_number1=%d\r\n",code_number1);
//		printf("code_number2=%d\r\n",code_number2);
//		printf("code_number3=%d\r\n",code_number3);
//		printf("code_number4=%d\r\n",code_number4);
//		printf("code_number5=%d\r\n",code_number5);
//		printf("code_number6=%d\r\n",code_number6);
//if(code_number1!=0&&code_number2!=0)
//{
//tin=1;
